        ...
        <form action="#" method="post">
            <div class="inpt">
                ...
                <select name="grade" id="grade">
                    <option value="" disabled selected>chosir un grade</option>
                    <option value="deux">2<sup>em</sup>  grade</option>
                    <option value="trois">3<sup>em</sup> grade</option>
                </select>
            </div>
            <div class="inpt">
                <i class="fas fa-pen"></i>
                <input type="text" placeholder="le titre de cour">
            </div>
            <div class="sub">
                <button type="submit">
                    Create
